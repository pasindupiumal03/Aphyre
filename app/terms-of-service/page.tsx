      ...
      <main className="ml-0 lg:ml-72 p-6 lg:p-12">
        ...
        <div className="mb-12 max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed text-pretty font-medium">
            Please read these terms carefully before using Alphyre.
          </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed">
                By accessing and using Alphyre, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </Card>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials (information or software) on Alphyre for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.
              </p>
              <p className="text-base text-muted-foreground font-medium leading-relaxed">
                Under this license you may not: copy or modify the materials; use the materials for any commercial purpose or for any public display; attempt to decompile or reverse engineer any software contained on Alphyre; remove any copyright or other proprietary notations from the materials.
              </p>
            </Card>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                The materials on Alphyre are provided as is. Alphyre makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
              </p>
              <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 mt-4">
                <p className="text-sm text-muted-foreground font-medium">
                  <strong>Investment Disclaimer:</strong> Alphyre does not provide investment advice. All information is for educational and informational purposes only. Always conduct your own research and consult with financial advisors before making trading decisions.
                </p>
              </div>
            </Card>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                In no event shall Alphyre or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Alphyre, even if Alphyre or an authorized representative has been notified orally or in writing of the possibility of such damage.
              </p>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                The materials appearing on Alphyre could include technical, typographical, or photographic errors. Alphyre does not warrant that any of the materials on the website are accurate, complete, or current.
              </p>
              <p className="text-base text-muted-foreground font-medium leading-relaxed">
                Alphyre may make changes to the materials contained on its website at any time without notice. However, Alphyre does not make any commitment to update the materials.
              </p>
            </Card>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                Alphyre owns or is licensed all content, graphics, and other materials on the website. All rights to these materials are reserved.
              </p>
              <ul className="space-y-3 text-base text-muted-foreground font-medium mt-4">
                <li className="flex gap-3">
                  <span className="text-accent font-bold">•</span>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed mb-4">
                If you create an account on Alphyre, you are responsible for:
              </p>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <p className="text-base text-muted-foreground font-medium leading-relaxed">
                Alphyre may revise these terms of service at any time without notice. By using the website, you are agreeing to be bound by the then current version of these terms of service. We will notify users of significant changes via email or prominent notice on the platform.
              </p>
            </Card>
            ...
            <Card className="p-8 border-border bg-card">
              ...
              <div className="space-y-2">
                <p className="text-base font-bold">Alphyre Legal Team</p>
              ...
              <div className="flex gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground font-medium mt-1">
                    Alphyre is committed to legal compliance and user protection.
                  </p>
                </div>
              </div>
            </Card>
